...
class BookController {
    ...
    static async deleteBook(bookId) {
        try {
            let idBook =await Book.findOneAndDelete({ _id: bookId._id })
    ...
    static async updateBook(bookId, bookForm) {
        try {
            ...
            let dataBook = await Book.find({ _id: _id }).populate('Author').exec()

            return { message: `Book with id:${_id} has been updated` }
